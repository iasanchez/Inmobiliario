                ...
                <div class="row range-slider">
                  ...
                  <div class="col-lg-3 col-md-12 col-xs-12">
                    <div class="text-right btn-section">
                      <button type="button" class="btn btn-common"><i class="lni-search" href="/busqueda"></i> Search</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-xs-12">
            <a href="listing.html" class="img-box">
              ...
              <div class="img-box-background">
                <img class="img-fluid" src="assets/img/place/img1.jpg" alt="">
              </div>
            </a>
          </div>
          <div class="col-lg-8 col-md-8 col-xs-12">
            <a href="listing.html" class="img-box">
              ...
              <div class="img-box-background">
                <img class="img-fluid" src="assets/img/place/img2.jpg" alt="">
              </div>
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-7 col-md-6 col-xs-12">
            <a href="listing.html" class="img-box">
              ...
              <div class="img-box-background">
                <img class="img-fluid" src="assets/img/place/img3.jpg" alt="">
              </div>
            </a>
          </div>
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-xs-12">
                <a href="listing.html" class="img-box card-hight">
                  ...
                  <div class="img-box-background">
                    <img class="img-fluid" src="assets/img/place/img4.jpg" alt="">
                  </div>
                </a>
              </div>
              <div class="col-lg-12 col-md-12 col-xs-12">
                <a href="listing.html" class="img-box card-hight">
                  ...
                  <div class="img-box-background">
                    <img class="img-fluid" src="assets/img/place/img5.jpg" alt="">
                  </div>
                </a>
              </div>
            </div>
